...
sap.ui.define([
	"de/adwizor/cloud/sdk/tutorial/firstapp-cf-frontend/controller/View1.controller"
	...
	QUnit.test("I should test the app controller loads", function (assert) {
		...
		assert.ok(sName, "de/adwizor/cloud/sdk/tutorial/firstapp-cf-frontend.controller.View1");
	});
